...
aboutTimeline.from("#about blockquote", {
  opacity: 0,
  y: 30,
  duration: 0.8,
  ease: "power2.out"
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  skillsTimeline.from("#skills .absolute.w-\\[2px\\]", {
    scaleY: 0,
    opacity: 0,
    duration: 1,
    stagger: 0.2,
  ...
  skillsTimeline.from(".frontend-skills .skill-icon", {
    opacity: 0,
    y: 30,
    scale: 0.8,
    duration: 0.6,
  ...
  skillsTimeline.from(".backend-skills h2", {
    opacity: 0,
    x: 40,
    duration: 0.6,
    ease: "back.out(1.2)"
  ...
  skillsTimeline.from(".backend-skills .skill-icon", {
    opacity: 0,
    y: 30,
    scale: 0.8,
    duration: 0.6,
  ...
  // Tools animation
  skillsTimeline.from(".tools-title", {
    opacity: 0,
    y: 20,
    duration: 0.6,
    ease: "power2.out"
  ...
  skillsTimeline.from(".tools-container .skill-icon", {
    opacity: 0,
    y: 30,
    scale: 0.8,
    duration: 0.6,
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Animate text
  contactTimeline.from(".contact-text", {
    opacity: 0,
    y: 30,
    duration: 0.7,
    ease: "power2.out"
  ...
  contactTimeline.from(".contact-item", {
    opacity: 0,
    x: -20,
    duration: 0.6,
    stagger: 0.15,
  ...
  contactTimeline.from(".form-input", {
    opacity: 0,
    y: 20,
    duration: 0.6,
    stagger: 0.1,
  ...
  contactTimeline.from(".form-button", {
    opacity: 0,
    y: 20,
    duration: 0.6,
    ease: "elastic.out(1, 0.5)"
